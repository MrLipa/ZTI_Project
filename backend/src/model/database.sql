...
WITH[
  ['Atlanta', 'Dallas', 800, '2023-05-14', 150, '5h 40m', 'Delta Airlines', 'Economy', 120],
  ['Chicago', 'Dallas', 1000, '2023-05-15', 160, '3h 20m', 'American Airlines', 'Business', 80],
  ['Dallas', 'Mexico City', 1300, '2023-05-16', 220, '6h 15m', 'Southwest Airlines', 'Economy', 200],
  ['Mexico City', 'Bogota', 1500, '2023-05-17', 230, '4h 50m', 'Avianca', 'Business', 100],
  ['Bogota', 'Rio de Janeiro', 1800, '2023-05-18', 240, '7h 30m', 'LATAM Airlines', 'Economy', 150],
  ['Rio de Janeiro', 'Chicago', 2000, '2023-05-19', 500, '8h 15m', 'United Airlines', 'Business', 250],
  ['Madrid', 'Paris', 1100, '2023-05-20', 110, '2h 40m', 'Iberia', 'Economy', 90],
  ['London', 'Paris', 900, '2023-05-21', 120, '3h 55m', 'British Airways', 'Business', 70],
  ['Rotterdam', 'London', 400, '2023-05-22', 130, '1h 10m', 'KLM Royal Dutch Airlines', 'Economy', 110],
  ['Rome', 'Rotterdam', 1100, '2023-05-23', 210, '6h 45m', 'Alitalia', 'Business', 120],
  ['London', 'Berlin', 900, '2023-05-24', 220, '2h 20m', 'Lufthansa', 'Economy', 80],
  ['Warsaw', 'Berlin', 1000, '2023-05-25', 230, '4h 30m', 'LOT Polish Airlines', 'Business', 150],
  ['Warsaw', 'Athens', 1500, '2023-05-26', 240, '5h 55m', 'Aegean Airlines', 'Economy', 100],
  ['Beijing', 'Hong Kong', 2000, '2023-05-27', 250, '9h 20m', 'Air China', 'Business', 180],
  ['Beijing', 'Shanghai', 1200, '2023-05-28', 260, '3h 45m', 'China Eastern Airlines', 'Economy', 200],
  ['Shanghai', 'Seoul', 800, '2023-05-29', 270, '2h 55m', 'Korean Air', 'Business', 120],
  ['Seoul', 'Tokyo', 900, '2023-05-30', 280, '4h 10m', 'Asiana Airlines', 'Economy', 150],
  ['Tokyo', 'Singapore', 1500, '2023-05-31', 290, '7h 25m', 'Singapore Airlines', 'Business', 200],
  ['Beijing', 'Singapore', 3000, '2023-06-01', 300, '10h 35m', 'Cathay Pacific', 'Economy', 250],
  ['Chicago', 'Shanghai', 9000, '2023-06-02', 1000, '13h 45m', 'United Airlines', 'Business', 300],
  ['Atlanta', 'Warsaw', 7500, '2023-06-03', 600, '12h 55m', 'LOT Polish Airlines', 'Economy', 180],
  ['Tokyo', 'Paris', 11000, '2023-06-04', 1200, '14h 20m', 'Air France', 'Business', 350]
] AS nested
UNWIND nested AS row
